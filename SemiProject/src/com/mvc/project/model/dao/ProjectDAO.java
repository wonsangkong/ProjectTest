...
//			pstmt.setString(1, "SEQ_PROJECT_NO.NEXTVAL");
	...
	public int updateProjectStatus(Connection conn, String projectNo, String status) {
		int result = 0;
		PreparedStatement pstmt = null;
			
		try {
			pstmt = conn.prepareStatement("UPDATE CARRYFUNDING_PROJECT SET PROJECT_STATUS=? WHERE PROJECT_NO=?");
	...
	public int getAdminProjectCount(Connection conn) {
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		int result = 0;
		String query = "SELECT COUNT(*) FROM CARRYFUNDING_PROJECT WHERE PROJECT_STATUS = 'Y'";
	...
	public CarryProject findAdminProjectByNo(Connection conn, int projectNo) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		CarryProject project = null;
		...
		String query =
			  ...
			  + "FROM CARRYFUNDING_PROJECT P\r\n"
			  + "JOIN MEMBER M ON(P.CREATOR_NO = M.USER_NO)\r\n"
			  + "WHERE P.PROJECT_STATUS = 'Y' AND P.PROJECT_NO = ?";
...
public List<CarryProject> adminFindAll(Connection conn, PageInfo info) {
...
//				project.setCreateNo(rs.getInt("CREATOR_NO"));
	...
	public int updateProjectCheckStatus(Connection conn, String projectNo, String status) {
		int result = 0;
		PreparedStatement pstmt = null;
		
		try {
			pstmt = conn.prepareStatement("UPDATE CARRYFUNDING_PROJECT SET PROJECT_CHECK=? WHERE PROJECT_NO=?");
