...
// 1.19 pageinfo 페이징 처리하는 class 추가
public class PageInfo {
	 ...
	 * @param pageLimit 한 페이지에 보여질 숫자 버튼의 수(기본 10까지) 
	 * @param listCount 전체 리스트 수
	 * @param listLimit 한 페이지에 표시될 페이지 수
	 */
